...
def _add_features_EURUSD(df: pd.DataFrame, include_mtf: bool = False) -> pd.DataFrame:
    ...
    fl_stochrsi_14, fl_ema21_50_diff, fl_close_vs_ema13, fl_macd_hist_slope_5,
    fl_pct_from_low_60, fl_pct_from_high_60, fl_donchian_trend_5, fl_pp_pos,
    ...
    fl_obv_slope_10, fl_squeeze_mom, fl_gap_open_atr, fl_squeeze,
    fl_range_vs_atr5, fl_ret_lag_4, fl_rv_5, fl_L_rel, fl_session_tokyo,
    fl_force_index_13, fl_ema50_200_diff, fl_roc_5, fl_time_in_trend_20,
    fl_ret_3, fl_rv_ratio_5_20, fl_run_len, fl_session_ny, fl_session_overlap,
    fl_cdl_morning_star, fl_ret_lag_1, fl_time_in_trend_5, fl_cmf_20,
    fl_inside_bar, fl_upper_wick, fl_cdl_engulf_bull, fl_hl_range, fl_ret_lag_3,
    fl_outside_bar, fl_vol_direction, fl_nvi_z, fl_cdl_evening_star,
...
def _add_features_XAUUSD(df: pd.DataFrame, include_mtf: bool = False, regime_params: dict = None) -> pd.DataFrame:
    ...
    Selected features (91 total):
        fl_regime, fl_aroon_osc_14, fl_z_60, fl_stochrsi_14, fl_close_vs_ema8,
    fl_ema21_50_diff, fl_di_plus, fl_di_minus, fl_tema14_vs_close, fl_trix_14,
    fl_macd_hist_norm, fl_momentum_vote, fl_donchian_trend_5, fl_rv_10,
    fl_force_index_13, fl_stoch_k, fl_stoch_kd_diff, fl_macd_hist_slope_5,
    ...
    fl_ema50_200_diff, fl_cdl_evening_star, fl_rv_ratio_20_60, fl_cmf_20,
    fl_lower_wick, fl_volume_z, fl_upper_wick, fl_outside_bar, fl_cdl_doji,
    fl_session_london, fl_slope_60, fl_ret_3, fl_price_loc_256, fl_er_14,
    fl_pp_pos, fl_ret_1, fl_ichi_senA_vs_senB, fl_cdl_inv_hammer,
    fl_atr_ratio_14, fl_cdl_harami, fl_cdl_piercing, fl_L_rel, fl_log_volume,
    fl_inside_bar, fl_ret_lag_4, fl_hl_range, fl_session_ny, fl_dow_sin,
    fl_time_in_trend_5, fl_er_60, fl_time_in_trend_20, fl_er_30, fl_ret_lag_5,
    fl_hour_cos, fl_gap_open_atr, fl_cdl_engulf_bull, fl_squeeze_mom,
